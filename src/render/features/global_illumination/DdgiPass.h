...
class DdgiPass final : public IRenderPass {
  public:
    DdgiPass(Device &device, const RenderResourcePool &resources,
  ...
  private:
    ...
    void createPersistentResources(const RenderResourcePool &resources);
    void createSamplingDescriptors(const RenderResourcePool &resources);
