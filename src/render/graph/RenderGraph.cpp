...
const Image &usageImage(const RenderResourcePool &resources,
...
void transitionUsage(
    VkCommandBuffer cmd, const RenderResourcePool &resources,
...
void RenderGraph::compile(const RenderResourcePool &resources,
                          const FrameRenderFeatures &features) {
...
void RenderGraph::onViewportResize(const RenderResourcePool &resources) {
    (void)resources;
    compiledValid_ = false;
    compiledCache_.clear();
    imageStates_.clear();
