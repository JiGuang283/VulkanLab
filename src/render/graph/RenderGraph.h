...
class RenderGraphBuilder {
  public:
    RenderGraphBuilder(const RenderResourcePool &resources,
                       const FrameRenderFeatures &features);
  ...
  private:
    const RenderResourcePool *resources_ = nullptr;
...
class RenderGraph {
  public:
    ...
    void compile(const RenderResourcePool &resources,
                 const struct FrameRenderFeatures &features);
    ...
    void onViewportResize(const RenderResourcePool &resources);
